	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
				...
				\subsubsection{Opis obrazaca uporabe}
					...
					\noindent \underbar{\textbf{UC6.1-plaćanje prilikom rezervacije}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC6.2-plaćanje sredstvima u novčaniku aplikacije}}
					\begin{packed_item}
					...
					\begin{packed_item}
						...
						\item  \textbf{Sudionici:} baza podataka
						\item  \textbf{Preduvjet:} prijava korisnika kao administratora
						\item  \textbf{Opis osnovnog tijeka:}
					...
					\noindent \underbar{\textbf{UC10-unos podataka o parkirnom mjestu}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik: }voditelj parkinga
						\item  \textbf{Cilj:} unos podataka o parkirnom mjestu
						\item  \textbf{Sudionici:} baza podataka
						\item  \textbf{Preduvjet:} registracija korisnika, voditeljski račun
						\item  \textbf{Opis osnovnog tijeka:}
					...
					\noindent \underbar{\textbf{UC11-postavljanje statusa dostupnosti parkirnog mjesta}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item  Voditelj odabire željeno parkirališno mjesto
							\item  Voditelj odabire opciju dostupno/nedostupno
							\item  Promjene se ažuriraju u bazi podataka
						\end{packed_enum}
					...
					\noindent \underbar{\textbf{UC12-pregledavanje statistike za parkiralište}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC13 -pregled parkirališnih mjesta}}
					\begin{packed_item}
			...
			\begin{figure}[]
				\centering
				\fbox{\includegraphics[width=\textwidth,keepaspectratio]{slike/UseCaseDijagram.png}}
